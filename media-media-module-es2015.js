...
let MediaGalleryComponent = class MediaGalleryComponent {
    constructor() {
    ...
    preview(index) {
        ...
        const viewer = new photoviewer__WEBPACK_IMPORTED_MODULE_2___default.a(this.images, options);
    }
};
...
const routes = [{ path: 'gallery', component: _gallery_gallery_component__WEBPACK_IMPORTED_MODULE_3__["MediaGalleryComponent"] }];
...
const COMPONENTS = [_gallery_gallery_component__WEBPACK_IMPORTED_MODULE_4__["MediaGalleryComponent"]];
