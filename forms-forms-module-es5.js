    ...
    DataService.prototype.getGithubAccounts = function (term) {
        ...
        if (term) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (rsp) { return rsp.items; }));
        }
        else {
...
var FormsDynamicComponent = /** @class */ (function () {
    ...
    FormsDynamicComponent.prototype.ngOnInit = function () { };
    FormsDynamicComponent.prototype.submit = function () {
        this.showToast();
    };
    FormsDynamicComponent.prototype.showToast = function () {
        this.toastr.success(JSON.stringify(this.model));
    };
    FormsDynamicComponent.ctorParameters = function () { return [
...
var FormsElementsComponent = /** @class */ (function () {
    function FormsElementsComponent(fb) {
        this.fb = fb;
        this.q = {
            username: '',
            email: '',
    ...
    FormsElementsComponent.prototype.getErrorMessage = function (form) {
    ...
    FormsElementsComponent.ctorParameters = function () { return [
...
var COMPONENTS = [_elements_elements_component__WEBPACK_IMPORTED_MODULE_4__["FormsElementsComponent"], _selects_selects_component__WEBPACK_IMPORTED_MODULE_5__["FormsSelectsComponent"], _dynamic_dynamic_component__WEBPACK_IMPORTED_MODULE_6__["FormsDynamicComponent"]];
...
var FormsSelectsComponent = /** @class */ (function () {
    function FormsSelectsComponent(dataService) {
    ...
    FormsSelectsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.people$ = this.dataService.getPeople();
        this.dataService.getPeople().subscribe(function (items) { return (_this.people = items); });
        this.simpleItems = [true, 'Two', 3];
        this.companiesNames.forEach(function (c, i) {
            _this.companies.push({ id: i, name: c });
        });
    };
    FormsSelectsComponent.prototype.toggleDisabled = function () {
        var car = this.cars[1];
        car.disabled = !car.disabled;
    };
    FormsSelectsComponent.prototype.addTag = function (name) {
        return { name: name, tag: true };
    };
    FormsSelectsComponent.prototype.addTagPromise = function (name) {
        var _this = this;
    ...
    FormsSelectsComponent.ctorParameters = function () { return [
