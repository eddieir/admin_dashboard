...
var AutocompleteComponent = /** @class */ (function () {
    ...
    AutocompleteComponent.prototype.filter = function (value) {
        if (value) {
...
var BottomSheetOverviewComponent = /** @class */ (function () {
    ...
    BottomSheetOverviewComponent.ctorParameters = function () { return [
...
var ButtonComponent = /** @class */ (function () {
    ...
    ButtonComponent.prototype.openSnackBar = function (message) {
        this.snackBar.open(message, '', {
            duration: 2000,
        });
    };
    ButtonComponent.prototype.increase = function () {
        this.counter++;
...
var CardComponent = /** @class */ (function () {
    ...
    CardComponent.prototype.openSnackbar = function (message) {
...
var CheckboxComponent = /** @class */ (function () {
    ...
    CheckboxComponent.prototype.allComplete = function (task) {
        var subtasks = task.subtasks;
        return task.completed || (subtasks != null && subtasks.every(function (t) { return t.completed; }));
    };
    CheckboxComponent.prototype.someComplete = function (tasks) {
        var numComplete = tasks.filter(function (t) { return t.completed; }).length;
        return numComplete > 0 && numComplete < tasks.length;
    };
    CheckboxComponent.prototype.setAllCompleted = function (tasks, completed) {
...
var ChipsComponent = /** @class */ (function () {
    ...
    ChipsComponent.prototype.displayMessage = function (message) {
    ...
    ChipsComponent.prototype.remove = function (person) {
...
var DialogComponent = /** @class */ (function () {
    ...
    DialogComponent.prototype.openFruitDialog = function () {
        var _this = this;
    ...
    DialogComponent.prototype.openWelcomeDialog = function () {
        this.dialog.open(DialogWelcomeComponent);
    };
    DialogComponent.prototype.openNeptuneDialog = function () {
        this.dialog.open(DialogNeptuneComponent);
    };
    DialogComponent.prototype.openAddressDialog = function () {
...
// Dialog
var DialogFruitComponent = /** @class */ (function () {
    function DialogFruitComponent() {
    }
...
var DialogWelcomeComponent = /** @class */ (function () {
    function DialogWelcomeComponent() {
    }
...
var DialogNeptuneComponent = /** @class */ (function () {
    function DialogNeptuneComponent(dialog) {
        this.dialog = dialog;
    }
    DialogNeptuneComponent.prototype.showInStackedDialog = function () {
        this.dialog.open(DialogNeptuneIFrameComponent);
    };
    DialogNeptuneComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
    ]; };
...
var DialogNeptuneIFrameComponent = /** @class */ (function () {
    function DialogNeptuneIFrameComponent() {
    }
...
var DialogAddressFormComponent = /** @class */ (function () {
    function DialogAddressFormComponent() {
    }
...
var IconComponent = /** @class */ (function () {
    ...
    IconComponent.prototype.deleteIcon = function () {
...
var InputComponent = /** @class */ (function () {
    ...
    Object.defineProperty(InputComponent.prototype, "passwordType", {
        get: function () {
    ...
    Object.defineProperty(InputComponent.prototype, "passwordToggleLabel", {
        get: function () {
    ...
    Object.defineProperty(InputComponent.prototype, "passwordToggleIcon", {
        get: function () {
    ...
    Object.defineProperty(InputComponent.prototype, "jpy", {
        get: function () {
    ...
    Object.defineProperty(InputComponent.prototype, "commentCount", {
        get: function () {
...
var SidenavBasicComponent = /** @class */ (function () {
    function SidenavBasicComponent() {
    }
...
var SidenavDualComponent = /** @class */ (function () {
    function SidenavDualComponent(snackbar) {
        this.snackbar = snackbar;
    }
    SidenavDualComponent.prototype.play = function (list) {
        this.snackbar.open("Playing \"" + list + "\"", '', { duration: 1000 });
    };
    SidenavDualComponent.ctorParameters = function () { return [
...
var SidenavMobileComponent = /** @class */ (function () {
    ...
    SidenavMobileComponent.prototype.ngOnDestroy = function () {
        // tslint:disable-next-line: deprecation
        this.mobileQuery.removeListener(this.mobileQueryListener);
    };
    SidenavMobileComponent.ctorParameters = function () { return [
...
var SlideToggleComponent = /** @class */ (function () {
    ...
    SlideToggleComponent.prototype.onFormSubmit = function () {
...
var SliderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(SliderComponent.prototype, "swatchBackground", {
        get: function () {
...
var SnackBarComponent = /** @class */ (function () {
    ...
    SnackBarComponent.prototype.openDiscoPartySnackBar = function () {
        this.snackBar.open('Disco party!', 'Dismiss', { duration: 5000 });
    };
    SnackBarComponent.prototype.openNotificationSnackBar = function () {
...
var BasicDataSource = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](BasicDataSource, _super);
    function BasicDataSource() {
        var _this = _super.call(this) || this;
        _this.dataChange = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
...
var SortDataSource = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SortDataSource, _super);
    ...
    SortDataSource.prototype.connect = function () {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"].apply(void 0, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](displayDataChanges)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () { return _this.getSortedData(); }));
    };
    SortDataSource.prototype.disconnect = function () { };
    SortDataSource.prototype.getSortedData = function () {
        var _this = this;
        var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](exampleData);
        if (!this.sort.active || this.sort.direction === '') {
            return data;
        }
        return data.sort(function (a, b) {
            return (a.age < b.age ? -1 : 1) * (_this.sort.direction === 'asc' ? 1 : -1);
        });
    };
    SortDataSource.ctorParameters = function () { return [
...
var PaginatedDataSource = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PaginatedDataSource, _super);
    ...
    PaginatedDataSource.prototype.connect = function () {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"].apply(void 0, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](displayDataChanges)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
            var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](exampleData);
    ...
    PaginatedDataSource.ctorParameters = function () { return [
    ...
    DynamicDataSource.prototype.toggleNode = function (node, expand) {
        ...
        setTimeout(function () {
            ...
            if (expand) {
                ...
                (_a = _this.data).splice.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([index + 1, 0], nodes));
            }
            else {
                var count = 0;
                for (var i = index + 1; i < _this.data.length && _this.data[i].level > node.level; i++, count++) { }
