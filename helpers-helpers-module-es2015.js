...
let HelpersCssClassComponent = class HelpersCssClassComponent {
    constructor() {
...
const routes = [{ path: 'css-class', component: _css_class_css_class_component__WEBPACK_IMPORTED_MODULE_3__["HelpersCssClassComponent"] }];
...
const COMPONENTS = [_css_class_css_class_component__WEBPACK_IMPORTED_MODULE_4__["HelpersCssClassComponent"]];
