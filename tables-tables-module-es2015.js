...
let TablesAdvancedComponent = class TablesAdvancedComponent {
    constructor(advancedSrv, cdr) {
    ...
    getData() {
        this.isLoading = true;
        this.advancedSrv.getData(this.params).subscribe((res) => {
            this.list = res.items;
...
TablesAdvancedComponent.ctorParameters = () => [
...
let TableAdvancedService = class TableAdvancedService {
    constructor(http) {
        this.http = http;
        this.columns = [
            {
...
TableAdvancedService.ctorParameters = () => [
...
let TableBasicComponent = class TableBasicComponent {
    constructor(basicSrv, dataSrv, dialog) {
    ...
    ngOnInit() {
        this.columns = this.basicSrv.getColumns(record => this.edit(record), record => this.delete(record));
        this.list = this.dataSrv.getData();
        this.isLoading = false;
    }
    edit(value) {
        const dialogRef = this.dialog.originalOpen(_edit_edit_component__WEBPACK_IMPORTED_MODULE_5__["TableBasicEditComponent"], {
            width: '600px',
            data: { record: value },
        });
...
TableBasicComponent.ctorParameters = () => [
...
let TableBasicService = class TableBasicService {
    constructor() {
        this.columns = [
            {
                title: 'Select',
...
let TableBasicEditComponent = class TableBasicEditComponent {
...
TableBasicEditComponent.ctorParameters = () => [
...
let TableRoutingModule = class TableRoutingModule {
};
...
const COMPONENTS = [_basic_basic_component__WEBPACK_IMPORTED_MODULE_4__["TableBasicComponent"], _advanced_advanced_component__WEBPACK_IMPORTED_MODULE_6__["TablesAdvancedComponent"]];
const COMPONENTS_DYNAMIC = [_basic_edit_edit_component__WEBPACK_IMPORTED_MODULE_5__["TableBasicEditComponent"]];
