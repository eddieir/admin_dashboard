...
var StartupService = /** @class */ (function () {
    function StartupService(menuService, http) {
    ...
    StartupService.prototype.load = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http
                ...
                _this.menuService.set(res.menu);
            }, function () { }, function () {
                resolve();
            });
        });
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dashboardSrv, ngZone, cdr) {
    ...
    DashboardComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.ngZone.runOutsideAngular(function () { return _this.initChart(); });
    };
...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.getCharts = function () {
        return this.charts;
    };
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'design',
                loadChildren: function () { return Promise.all(/*! import() | design-design-module */[__webpack_require__.e("default~design-design-module~extensions-extensions-module~helpers-helpers-module~media-media-module~~108f0a1f"), __webpack_require__.e("design-design-module")]).then(__webpack_require__.bind(null, /*! ./design/design.module */ "./src/app/routes/design/design.module.ts")).then(function (m) { return m.DesignModule; }); },
                data: { title: 'Design', titleI18n: 'design' },
            },
            {
                path: 'material',
                loadChildren: function () { return __webpack_require__.e(/*! import() | material-material-module */ "material-material-module").then(__webpack_require__.bind(null, /*! ./material/material.module */ "./src/app/routes/material/material.module.ts")).then(function (m) { return m.MaterialModule; }); },
                data: { title: 'Material', titleI18n: 'material' },
            },
            {
                path: 'media',
                loadChildren: function () { return Promise.all(/*! import() | media-media-module */[__webpack_require__.e("default~design-design-module~extensions-extensions-module~helpers-helpers-module~media-media-module~~108f0a1f"), __webpack_require__.e("media-media-module")]).then(__webpack_require__.bind(null, /*! ./media/media.module */ "./src/app/routes/media/media.module.ts")).then(function (m) { return m.MediaModule; }); },
                data: { title: 'Media', titleI18n: 'media' },
            },
            {
                path: 'forms',
                loadChildren: function () { return __webpack_require__.e(/*! import() | forms-forms-module */ "forms-forms-module").then(__webpack_require__.bind(null, /*! ./forms/forms.module */ "./src/app/routes/forms/forms.module.ts")).then(function (m) { return m.FormsModule; }); },
                data: { title: 'Forms', titleI18n: 'forms' },
            },
            {
                path: 'tables',
                loadChildren: function () { return Promise.all(/*! import() | tables-tables-module */[__webpack_require__.e("default~design-design-module~extensions-extensions-module~helpers-helpers-module~media-media-module~~108f0a1f"), __webpack_require__.e("tables-tables-module")]).then(__webpack_require__.bind(null, /*! ./tables/tables.module */ "./src/app/routes/tables/tables.module.ts")).then(function (m) { return m.TablesModule; }); },
                data: { title: 'Tables', titleI18n: 'tables' },
            },
            {
                path: 'profile',
                loadChildren: function () { return __webpack_require__.e(/*! import() | profile-profile-module */ "profile-profile-module").then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/routes/profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
                data: { title: 'Profile', titleI18n: 'profile' },
            },
            {
                path: 'sessions',
                loadChildren: function () { return __webpack_require__.e(/*! import() | sessions-sessions-module */ "sessions-sessions-module").then(__webpack_require__.bind(null, /*! ./sessions/sessions.module */ "./src/app/routes/sessions/sessions.module.ts")).then(function (m) { return m.SessionsModule; }); },
                data: { title: 'Sessions', titleI18n: 'sessions' },
            },
            {
                path: 'helpers',
                loadChildren: function () { return Promise.all(/*! import() | helpers-helpers-module */[__webpack_require__.e("default~design-design-module~extensions-extensions-module~helpers-helpers-module~media-media-module~~108f0a1f"), __webpack_require__.e("helpers-helpers-module")]).then(__webpack_require__.bind(null, /*! ./helpers/helpers.module */ "./src/app/routes/helpers/helpers.module.ts")).then(function (m) { return m.HelpersModule; }); },
            },
            {
                path: 'extensions',
                loadChildren: function () { return Promise.all(/*! import() | extensions-extensions-module */[__webpack_require__.e("default~design-design-module~extensions-extensions-module~helpers-helpers-module~media-media-module~~108f0a1f"), __webpack_require__.e("extensions-extensions-module")]).then(__webpack_require__.bind(null, /*! ./extensions/extensions.module */ "./src/app/routes/extensions/extensions.module.ts")).then(function (m) { return m.ExtensionsModule; }); },
            },
        ],
    },
    {
...
var COMPONENTS = [_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], _sessions_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _sessions_register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"]];
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb) {
        ...
        this.confirmValidator = function (control) {
            ...
            else if (control.value !== _this.reactiveForm.controls.password.value) {
...
var BreadcrumbComponent = /** @class */ (function () {
    function BreadcrumbComponent(router, menuService) {
        this.router = router;
        this.menuService = menuService;
        this.nav = [];
    }
    ...
    BreadcrumbComponent.prototype.trackByNavlink = function (index, navlink) {
        return navlink;
    };
    BreadcrumbComponent.prototype.genBreadcrumb = function () {
        var states = this.router.url.slice(1).split('/');
...
var PageHeaderComponent = /** @class */ (function () {
    function PageHeaderComponent(router, menuService) {
        this.router = router;
        this.menuService = menuService;
        this.title = '';
        this.subtitle = '';
...
/* harmony import */ var _ngx_progressbar_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ngx-progressbar/router */ "./node_modules/@ngx-progressbar/router/fesm5/ngx-progressbar-router.js");
...
/* harmony import */ var _ngx_formly_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ngx-formly/core */ "./node_modules/@ngx-formly/core/fesm5/ngx-formly-core.js");
...
/* harmony import */ var _ng_matero_extensions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ng-matero/extensions */ "./node_modules/@ng-matero/extensions/fesm5/extensions.js");
...
var COMPONENTS = [_components_breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_13__["BreadcrumbComponent"], _components_page_header_page_header_component__WEBPACK_IMPORTED_MODULE_14__["PageHeaderComponent"], _components_error_code_error_code_component__WEBPACK_IMPORTED_MODULE_15__["ErrorCodeComponent"]];
var COMPONENTS_DYNAMIC = [];
var DIRECTIVES = [];
var PIPES = [];
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](COMPONENTS, DIRECTIVES, PIPES),
            imports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]], THIRD_MODULES),
            exports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]
            ], THIRD_MODULES, COMPONENTS, DIRECTIVES, PIPES),
            entryComponents: COMPONENTS_DYNAMIC,
        })
    ], SharedModule);
    return SharedModule;
...
var AdminLayoutComponent = /** @class */ (function () {
    function AdminLayoutComponent(router, breakpointObserver, overlay, settings) {
        var _this = this;
        this.router = router;
...
var SidebarNoticeComponent = /** @class */ (function () {
    function SidebarNoticeComponent() {
    }
...
var AccordionAnchorDirective = /** @class */ (function () {
    ...
    AccordionAnchorDirective.prototype.onClick = function () {
        this.navlink.toggle();
    };
...
var SidemenuComponent = /** @class */ (function () {
    function SidemenuComponent(menuService) {
        this.menuService = menuService;
    ...
    SidemenuComponent.prototype.filterStates = function (states) {
        return states.filter(function (item) { return item && item.trim(); });
    };
...
var TopmenuComponent = /** @class */ (function () {
    function TopmenuComponent(menuService) {
        this.menuService = menuService;
        this.menus = this.menuService.getAll();
    }
    TopmenuComponent.prototype.ngOnInit = function () { };
    // Delete empty value in array
    TopmenuComponent.prototype.filterStates = function (states) {
        return states.filter(function (item) { return item && item.trim(); });
    };
